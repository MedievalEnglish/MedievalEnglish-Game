...
function InitItems(){
	...
	global.items[ITEM_NOTE10] = CreateItem("Nota quince", "El verbo to be significa ser o estar y usualmente se utiliza con los pronombres personales Personal pronouns.", spr_note, usenote10, 1);
	global.items[ITEM_NOTE10C] = CreateItem("Nota quince", "El verbo to be significa ser o estar y usualmente se utiliza con los pronombres personales Personal pronouns.", spr_note, usenote10c, 1);
	global.items[ITEM_NOTE10CO] = CreateItem("Nota quince", "El verbo to be significa ser o estar y usualmente se utiliza con los pronombres personales Personal pronouns.", spr_note, usenote10co, 1);
	global.items[ITEM_NOTE10MA] = CreateItem("Nota quince", "El verbo to be significa ser o estar y usualmente se utiliza con los pronombres personales Personal pronouns.", spr_note, usenote10ma, 1);
	global.items[ITEM_NOTE11] = CreateItem("Nota dieciséis", "estos son algunos pronombres: I am yo soy o yo estoy, You are tú eres o tu estás y He is él es o el está", spr_note, usenote11, 1);
	global.items[ITEM_NOTE11C] = CreateItem("Nota dieciséis", "estos son algunos pronombres: I am yo soy o yo estoy, You are tú eres o tu estás y He is él es o el está", spr_note, usenote11c, 1);
	global.items[ITEM_NOTE11CO] = CreateItem("Nota dieciséis", "estos son algunos pronombres: I am yo soy o yo estoy, You are tú eres o tu estás y He is él es o el está", spr_note, usenote11co, 1);
	global.items[ITEM_NOTE11MA] = CreateItem("Nota dieciséis", "estos son algunos pronombres: I am yo soy o yo estoy, You are tú eres o tu estás y He is él es o el está", spr_note, usenote11ma, 1);
	global.items[ITEM_NOTE12] = CreateItem("Nota diecisiete", "estos son algunos pronombres: She is ella es o ella está y We are nosotros somos o nosotros estamos", spr_note, usenote12, 1);
	global.items[ITEM_NOTE12C] = CreateItem("Nota diecisiete", "estos son algunos pronombres: She is ella es o ella está y We are nosotros somos o nosotros estamos", spr_note, usenote12c, 1);
	global.items[ITEM_NOTE12CO] = CreateItem("Nota diecisiete", "estos son algunos pronombres: She is ella es o ella está y We are nosotros somos o nosotros estamos", spr_note, usenote12co, 1);
	global.items[ITEM_NOTE12MA] = CreateItem("Nota diecisiete", "estos son algunos pronombres: She is ella es o ella está y We are nosotros somos o nosotros estamos", spr_note, usenote12ma, 1);
	global.items[ITEM_NOTE13] = CreateItem("Nota dieciocho", "estos son algunos pronombres: It is es o está para objetos o animales, They are ellos son o ellos están y You are ustedes, ustedes son o ustedes están", spr_note, usenote13, 1);
	global.items[ITEM_NOTE13C] = CreateItem("nota dieciocho", "estos son algunos pronombres: It is es o está para objetos o animales, They are ellos son o ellos están y You are ustedes, ustedes son o ustedes están", spr_note, usenote13c, 1);
	global.items[ITEM_NOTE13CO] = CreateItem("nota dieciocho", "estos son algunos pronombres: It is es o está para objetos o animales, They are ellos son o ellos están y You are ustedes, ustedes son o ustedes están", spr_note, usenote13co, 1);
	global.items[ITEM_NOTE13MA] = CreateItem("nota dieciocho", "estos son algunos pronombres: It is es o está para objetos o animales, They are ellos son o ellos están y You are ustedes, ustedes son o ustedes están", spr_note, usenote13ma, 1);
	global.items[ITEM_NOTE14] = CreateItem("nota diez", "Kitchen / Cocina", spr_note, usenote14, 1);
	global.items[ITEM_NOTE14C] = CreateItem("nota diez", "Kitchen / Cocina", spr_note, usenote14c, 1);
	global.items[ITEM_NOTE14CO] = CreateItem("nota diez", "Kitchen / Cocina", spr_note, usenote14co, 1);
	global.items[ITEM_NOTE14MA] = CreateItem("nota diez", "Kitchen / Cocina", spr_note, usenote14ma, 1);
	global.items[ITEM_NOTE15] = CreateItem("nota once", "Bedroom / Dormitorio", spr_note, usenote15, 1);
	global.items[ITEM_NOTE15C] = CreateItem("nota once", "Bedroom / Dormitorio", spr_note, usenote15c, 1);
	global.items[ITEM_NOTE15CO] = CreateItem("nota once", "Bedroom / Dormitorio", spr_note, usenote15co, 1);
	global.items[ITEM_NOTE15MA] = CreateItem("nota once", "Bedroom / Dormitorio", spr_note, usenote15ma, 1);
	global.items[ITEM_NOTE16] = CreateItem("nota doce", "Living room / Sala", spr_note, usenote16, 1);
	global.items[ITEM_NOTE16C] = CreateItem("nota doce", "Living room / Sala", spr_note, usenote16c, 1);
	global.items[ITEM_NOTE16CO] = CreateItem("nota doce", "Living room / Sala", spr_note, usenote16co, 1);
	global.items[ITEM_NOTE16MA] = CreateItem("nota doce", "Living room / Sala", spr_note, usenote16ma, 1);
	global.items[ITEM_NOTE17] = CreateItem("nota trece", "Bathroom / Baño", spr_note, usenote17, 1);
	global.items[ITEM_NOTE17C] = CreateItem("nota trece", "Bathroom / Baño", spr_note, usenote17c, 1);
	global.items[ITEM_NOTE17CO] = CreateItem("nota trece", "Bathroom / Baño", spr_note, usenote17co, 1);
	global.items[ITEM_NOTE17MA] = CreateItem("nota trece", "Bathroom / Baño", spr_note, usenote17ma, 1);
	global.items[ITEM_NOTE18] = CreateItem("nota catorce", "Dinning room / Comedor", spr_note, usenote18, 1);
	global.items[ITEM_NOTE18C] = CreateItem("nota catorce", "Dinning room / Comedor", spr_note, usenote18c, 1);
	global.items[ITEM_NOTE18CO] = CreateItem("nota catorce", "Dinning room / Comedor", spr_note, usenote18co, 1);
	global.items[ITEM_NOTE18MA] = CreateItem("nota catorce", "Dinning room / Comedor", spr_note,usenote18ma , 1);
